...
@MainActor
public struct PenguinChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    public init(
        viewModel: PenguinChatViewModel,
    ...
    private var visibleMessages: [PenguinChatMessage] {
        let base: [PenguinChatMessage]
    ...
    private func mergeToolResults(in messages: [PenguinChatMessage]) -> [PenguinChatMessage] {
    ...
    private func isToolResultMessage(_ message: PenguinChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: PenguinChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: PenguinChatMessage) -> String {
