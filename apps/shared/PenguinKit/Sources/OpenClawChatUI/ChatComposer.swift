...
@MainActor
struct PenguinChatComposer: View {
    @Bindable var viewModel: PenguinChatViewModel
        ...
        .background {
            ...
            if self.style == .standard {
                let shape = UnevenRoundedRectangle(
                    ...
                    style: .continuous)
                shape
                    .fill(PenguinChatTheme.composerBackground)
                    .overlay(shape.strokeBorder(PenguinChatTheme.composerBorder, lineWidth: 1))
        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 6) {
                ForEach(
                    ...
                    id: \PenguinPendingAttachment.id)
                { (att: PenguinPendingAttachment) in
                    HStack(spacing: 6) {
                        if let img = att.preview {
                            PenguinPlatformImageFactory.image(img)
                                .resizable()
                                .scaledToFill()
    ...
    private var editor: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 12, style: .continuous)
                .fill(PenguinChatTheme.composerField)
                .overlay(
                    RoundedRectangle(cornerRadius: 12, style: .continuous)
                        .strokeBorder(PenguinChatTheme.composerBorder)))
    ...
    private var connectionPill: some View {
        ...
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(PenguinChatTheme.subtleCard)
        .clipShape(Capsule())
    }
