...
public typealias PenguinPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias PenguinPlatformImage = UIImage
#endif

public struct PenguinChatUsageCost: Codable, Hashable, Sendable {
...
public struct PenguinChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: PenguinChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(PenguinChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct PenguinChatMessageContent: Codable, Hashable, Sendable {
...
public struct PenguinChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [PenguinChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: PenguinChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [PenguinChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: PenguinChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(PenguinChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([PenguinChatMessageContent].self, forKey: .content) {
...
public struct PenguinChatHistoryPayload: Codable, Sendable {
...
public struct PenguinSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct PenguinSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [PenguinSessionPreviewItem]
}

public struct PenguinSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [PenguinSessionPreviewEntry]

    public init(ts: Int, previews: [PenguinSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct PenguinChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct PenguinChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct PenguinAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct PenguinChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct PenguinGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct PenguinPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: PenguinPlatformImage?
...
public struct PenguinChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
