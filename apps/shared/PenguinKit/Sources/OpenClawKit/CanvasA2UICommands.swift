...
public enum PenguinCanvasA2UICommand: String, Codable, Sendable {
...
public struct PenguinCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PenguinCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
