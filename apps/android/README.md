## Penguin Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_penguin-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm penguin gateway --port 18789 --verbose
```
