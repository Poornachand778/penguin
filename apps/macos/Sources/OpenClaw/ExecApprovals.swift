...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.penguin", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        PenguinPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        PenguinPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
