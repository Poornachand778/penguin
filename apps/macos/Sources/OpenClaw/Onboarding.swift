...
enum UIStrings {
    static let welcomeTitle = "Welcome to Penguin"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: PenguinOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: PenguinChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g penguin@\(version)"
    }
