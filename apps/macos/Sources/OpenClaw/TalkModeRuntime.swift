...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.penguin", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.penguin", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [PenguinChatMessage] = messages.compactMap { item in
