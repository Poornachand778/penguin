...
extension OnboardingView {
    ...
    func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .penguinSelectSettingsTab, object: tab)
        }
    }
    ...
    func finish() {
        UserDefaults.standard.set(true, forKey: "penguin.onboardingSeen")
    ...
    func finishAnthropicOAuth() async {
        ...
        do {
            ...
            self.anthropicAuthStatus = "Connected. Penguin can now use Claude."
        } catch {
