...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/penguin/penguin") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/penguin/penguin")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://penguin.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "PenguinBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "PenguinBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "PenguinGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "PenguinGitCommit") as? String) ??
            "unknown"
    }
