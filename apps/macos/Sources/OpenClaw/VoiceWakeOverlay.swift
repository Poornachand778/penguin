...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.penguin", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Penguin windows, but below the system’s pop-up menus.
