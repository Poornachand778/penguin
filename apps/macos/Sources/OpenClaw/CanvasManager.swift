...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.penguin", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Penguin/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__penguin__/a2ui/").absoluteString + "?platform=macos"
    }
