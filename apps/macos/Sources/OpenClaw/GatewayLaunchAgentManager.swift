...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.penguin", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".penguin/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.penguinCommand(
            subcommand: "gateway",
