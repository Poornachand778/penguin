...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = PenguinConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PenguinConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = PenguinConfigFile.loadDict()
            ...
            PenguinConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/penguin"
        state.remoteCliPath = ""
        return state
    }
}
