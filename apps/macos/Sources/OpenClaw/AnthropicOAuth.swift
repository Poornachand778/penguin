...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Penguin token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: PenguinOAuthStore.AnthropicOAuthStatus = PenguinOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.penguin", category: "anthropic-oauth")
...
enum PenguinOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let penguinOAuthDirEnv = "PENGUIN_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Penguin OAuth token file not found"
            case .unreadableFile: "Penguin OAuth token file not readable"
            case .invalidJSON: "Penguin OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Penguin OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Penguin OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.penguinOAuthDirEnv]?
        ...
        let preferred = home.appendingPathComponent(".penguin", isDirectory: true)
