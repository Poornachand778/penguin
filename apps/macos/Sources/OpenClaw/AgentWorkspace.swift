...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.penguin", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return PenguinConfigFile.defaultWorkspaceURL() }
