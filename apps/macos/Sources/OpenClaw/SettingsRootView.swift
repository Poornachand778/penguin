...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .penguinSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? PenguinPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? PenguinPaths.stateDirURL.path
...
extension Notification.Name {
    static let penguinSelectSettingsTab = Notification.Name("penguinSelectSettingsTab")
}
