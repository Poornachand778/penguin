...
final class ScreenController {
    ...
    /// Callback invoked when an penguin:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = PenguinKitResources.bundle
...
/// Handles navigation policy to intercept penguin:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept penguin:// deep links.
        if url.scheme?.lowercased() == "penguin" {
