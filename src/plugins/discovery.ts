...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @penguin/voice-call -> voice-call).
...
export function discoverPenguinPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".penguin", "extensions")];
