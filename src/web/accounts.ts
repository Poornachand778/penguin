...
function listConfiguredAccountIds(cfg: PenguinConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: PenguinConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: PenguinConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: PenguinConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: PenguinConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: PenguinConfig): ResolvedWhatsAppAccount[] {
