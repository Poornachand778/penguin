...
export function listSlackAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: PenguinConfig): string {
...
function mergeSlackAccountConfig(cfg: PenguinConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: PenguinConfig): ResolvedSlackAccount[] {
