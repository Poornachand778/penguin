...
import type { PenguinConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: PenguinConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: PenguinConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: PenguinConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: PenguinConfig) => void;
  log: {
