...
import { type PenguinConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: PenguinConfig): string[] {
...
export function listAgentsForGateway(cfg: PenguinConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: PenguinConfig): string {
...
function resolveSessionStoreAgentId(cfg: PenguinConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: PenguinConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: PenguinConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: PenguinConfig): GatewaySessionsDefaults {
