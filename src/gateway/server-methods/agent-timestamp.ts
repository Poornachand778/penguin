 ...
 *
 * @see https://github.com/penguin/penguin/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an PenguinConfig.
 */
export function timestampOptsFromConfig(cfg: PenguinConfig): TimestampInjectionOptions {
  return {
