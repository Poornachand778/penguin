...
export function listIMessageAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: PenguinConfig): string {
...
function mergeIMessageAccountConfig(cfg: PenguinConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: PenguinConfig): ResolvedIMessageAccount[] {
