...
import { discoverPenguinPlugins } from "../../plugins/discovery.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { PenguinPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, PenguinPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["PENGUIN_PLUGIN_CATALOG_PATHS", "PENGUIN_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<PenguinPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: PenguinPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: PenguinPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverPenguinPlugins({ workspaceDir: options.workspaceDir });
