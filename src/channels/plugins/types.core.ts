...
export type ChannelAgentToolFactory = (params: { cfg?: PenguinConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PenguinConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: PenguinConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PenguinConfig }) => boolean;
  supportsCards?: (params: { cfg: PenguinConfig }) => boolean;
