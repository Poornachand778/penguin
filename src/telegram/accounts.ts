...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.PENGUIN_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: PenguinConfig): string {
...
function mergeTelegramAccountConfig(cfg: PenguinConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: PenguinConfig): ResolvedTelegramAccount[] {
