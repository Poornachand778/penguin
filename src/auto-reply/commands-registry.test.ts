...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@penguin", { botUsername: "penguin" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@penguin args", {
        botUsername: "penguin",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "penguin" })).toBe(
      "/help@otherbot",
    );
  });
