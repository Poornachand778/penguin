...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.PENGUIN_STATE_DIR;
  const configPath = env.PENGUIN_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    PENGUIN_PROFILE: profile,
    PENGUIN_STATE_DIR: stateDir,
    PENGUIN_CONFIG_PATH: configPath,
    PENGUIN_GATEWAY_PORT: String(port),
    PENGUIN_GATEWAY_TOKEN: token,
    PENGUIN_LAUNCHD_LABEL: resolvedLaunchdLabel,
    PENGUIN_SYSTEMD_UNIT: systemdUnit,
    PENGUIN_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    PENGUIN_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    PENGUIN_STATE_DIR: stateDir,
    PENGUIN_CONFIG_PATH: configPath,
    PENGUIN_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    PENGUIN_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    PENGUIN_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    PENGUIN_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    PENGUIN_LOG_PREFIX: "node",
    PENGUIN_SERVICE_MARKER: NODE_SERVICE_MARKER,
    PENGUIN_SERVICE_KIND: NODE_SERVICE_KIND,
    PENGUIN_SERVICE_VERSION: VERSION,
  };
}
