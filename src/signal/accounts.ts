...
export function listSignalAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: PenguinConfig): string {
...
function mergeSignalAccountConfig(cfg: PenguinConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: PenguinConfig): ResolvedSignalAccount[] {
