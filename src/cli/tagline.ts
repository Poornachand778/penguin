const DEFAULT_TAGLINE = "All your chats, one Penguin.";
...
const TAGLINES: string[] = [
  "Your terminal just got a penguin—type something and let the bot handle the busywork.",
  ...
  "Automation with wings: minimal fuss, maximal waddle.",
  ...
  "Wings out, commit in—let's ship something mildly responsible.",
  "I'll glide through your workflow like a penguin on ice: smooth, cool, effective.",
  "Shell yeah—I'm here to tackle the toil and leave you the glory.",
  ...
  "The only penguin in your contacts you actually want to hear from. 🐧",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.PENGUIN_TAGLINE_INDEX;
