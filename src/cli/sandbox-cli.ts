...
const SANDBOX_EXAMPLES = {
  main: [
    ["penguin sandbox list", "List all sandbox containers."],
    ["penguin sandbox list --browser", "List only browser containers."],
    ["penguin sandbox recreate --all", "Recreate all containers."],
    ["penguin sandbox recreate --session main", "Recreate a specific session."],
    ["penguin sandbox recreate --agent mybot", "Recreate agent containers."],
    ["penguin sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["penguin sandbox list", "List all sandbox containers."],
    ["penguin sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["penguin sandbox recreate --all", "Recreate all containers."],
    ["penguin sandbox recreate --session main", "Recreate a specific session."],
    ["penguin sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["penguin sandbox recreate --browser --all", "Recreate only browser containers."],
    ["penguin sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["penguin sandbox explain", "Show effective sandbox config."],
    ["penguin sandbox explain --session agent:main:main", "Explain a specific session."],
    ["penguin sandbox explain --agent work", "Explain an agent sandbox."],
    ["penguin sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.penguin.ai/cli/sandbox")}\n`,
    )
    .action(() => {
