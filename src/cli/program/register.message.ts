...
${formatHelpExamples([
  ['penguin message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'penguin message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'penguin message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.penguin.ai/cli/message")}`,
    )
    .action(() => {
