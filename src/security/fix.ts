...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PenguinConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PenguinConfig; env: NodeJS.ProcessEnv }): {
  cfg: PenguinConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
