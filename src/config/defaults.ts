...
function resolveAnthropicDefaultAuthMode(cfg: PenguinConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: PenguinConfig): PenguinConfig {
...
export function applyTalkApiKey(config: PenguinConfig): PenguinConfig {
...
export function applyModelDefaults(cfg: PenguinConfig): PenguinConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: PenguinConfig): PenguinConfig {
...
export function applyLoggingDefaults(cfg: PenguinConfig): PenguinConfig {
...
export function applyContextPruningDefaults(cfg: PenguinConfig): PenguinConfig {
...
export function applyCompactionDefaults(cfg: PenguinConfig): PenguinConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
