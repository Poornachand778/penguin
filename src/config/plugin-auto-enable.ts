import type { PenguinConfig } from "./config.js";
import {
  getChatChannelMeta,
  listChatChannels,
...
function isTelegramConfigured(cfg: PenguinConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: PenguinConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: PenguinConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: PenguinConfig): boolean {
...
function isIMessageConfigured(cfg: PenguinConfig): boolean {
...
function isWhatsAppConfigured(cfg: PenguinConfig): boolean {
...
function isGenericChannelConfigured(cfg: PenguinConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: PenguinConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: PenguinConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: PenguinConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: PenguinConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: PenguinConfig, pluginId: string): PenguinConfig {
...
function enablePluginEntry(cfg: PenguinConfig, pluginId: string): PenguinConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
