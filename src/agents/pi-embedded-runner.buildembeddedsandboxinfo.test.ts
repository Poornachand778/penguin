...
const _makeOpenAiConfig = (modelIds: string[]) =>
  ...
  }) satisfies PenguinConfig;

const _ensureModels = (cfg: PenguinConfig, agentDir: string) =>
  ensurePenguinModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/penguin-sandbox",
      agentWorkspaceDir: "/tmp/penguin-workspace",
      ...
      browser: {
        ...
        containerName: "penguin-sbx-browser-test",
      },
