...
function resolveExecConfig(cfg: PenguinConfig | undefined) {
...
export function createPenguinCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createPenguinReadTool(freshReadTool)];
    }
