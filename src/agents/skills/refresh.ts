...
function resolveWatchPaths(workspaceDir: string, config?: PenguinConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: PenguinConfig }) {
