...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolvePenguinAgentDir() returns mainAgentDir
    process.env.PENGUIN_STATE_DIR = tmpDir;
    process.env.PENGUIN_AGENT_DIR = mainAgentDir;
