...
function resolveAvatarSource(cfg: PenguinConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: PenguinConfig, agentId: string): AgentAvatarResolution {
