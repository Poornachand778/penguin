...
describe("createPenguinCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createPenguinCodingTools({
      config,
    ...
    const anthropicTools = createPenguinCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createPenguinCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createPenguinCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
