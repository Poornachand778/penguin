...
import { createPenguinCodingTools } from "./pi-tools.js";
...
describe("Agent-specific tool filtering", () => {
  it("should apply global tool policy when no agent-specific policy exists", () => {
    ...
    const tools = createPenguinCodingTools({
      config: cfg,
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createPenguinCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createPenguinCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createPenguinCodingTools({
      config: cfg,
    ...
    const defaultTools = createPenguinCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createPenguinCodingTools({
      config: cfg,
    ...
    const bobTools = createPenguinCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createPenguinCodingTools({
      config: cfg,
