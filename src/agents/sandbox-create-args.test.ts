  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "penguin.sandbox=1",
        "--label",
        "penguin.sessionKey=main",
        "--label",
        "penguin.createdAtMs=1700000000000",
        "--label",
        "penguin.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
