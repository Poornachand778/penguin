...
const ensurePenguinModelsJson = vi.fn().mockResolvedValue(undefined);
const resolvePenguinAgentDir = vi.fn().mockReturnValue("/tmp/penguin-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/penguin-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensurePenguinModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolvePenguinAgentDir,
}));
