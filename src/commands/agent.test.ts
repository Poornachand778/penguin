...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "penguin-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<PenguinConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<PenguinConfig["telegram"]>>,
