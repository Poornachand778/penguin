...
export function applyZaiConfig(cfg: PenguinConfig): PenguinConfig {
...
export function applyOpenrouterProviderConfig(cfg: PenguinConfig): PenguinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: PenguinConfig): PenguinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: PenguinConfig): PenguinConfig {
...
export function applyOpenrouterConfig(cfg: PenguinConfig): PenguinConfig {
...
export function applyMoonshotProviderConfig(cfg: PenguinConfig): PenguinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: PenguinConfig): PenguinConfig {
...
export function applyKimiCodeProviderConfig(cfg: PenguinConfig): PenguinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: PenguinConfig): PenguinConfig {
...
export function applySyntheticProviderConfig(cfg: PenguinConfig): PenguinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: PenguinConfig): PenguinConfig {
...
export function applyXiaomiProviderConfig(cfg: PenguinConfig): PenguinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: PenguinConfig): PenguinConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: PenguinConfig): PenguinConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: PenguinConfig): PenguinConfig {
