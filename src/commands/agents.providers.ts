...
function resolveDefaultAccountId(cfg: PenguinConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: PenguinConfig): boolean {
...
export function summarizeBindings(cfg: PenguinConfig, bindings: AgentBinding[]): string[] {
