...
function resolveConfiguredModelRaw(cfg: PenguinConfig): string {
...
function resolveConfiguredModelKeys(cfg: PenguinConfig): string[] {
...
export function applyPrimaryModel(cfg: PenguinConfig, model: string): PenguinConfig {
...
export function applyModelAllowlist(cfg: PenguinConfig, models: string[]): PenguinConfig {
  const defaults = cfg.agents?.defaults;
