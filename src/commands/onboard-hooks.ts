...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.penguin.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("penguin hooks list")}`,
      `  ${formatCliCommand("penguin hooks enable <name>")}`,
      `  ${formatCliCommand("penguin hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
