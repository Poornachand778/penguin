...
import type { PenguinPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: PenguinPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: PenguinPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
