...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: PenguinConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: PenguinConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: PenguinConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: PenguinConfig): void {
