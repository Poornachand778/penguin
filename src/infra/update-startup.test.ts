...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "penguin-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolvePenguinPackageRoot } = await import("./penguin-root.js");
    ...
    vi.mocked(resolvePenguinPackageRoot).mockResolvedValue("/opt/penguin");
