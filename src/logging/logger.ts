...
export const DEFAULT_LOG_DIR = "/tmp/penguin";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "penguin.log"); // legacy single-file path

const LOG_PREFIX = "penguin";
...
function resolveSettings(): ResolvedSettings {
  let cfg: PenguinConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => PenguinConfig;
      };
