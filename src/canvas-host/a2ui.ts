...
export const A2UI_PATH = "/__penguin__/a2ui";

export const CANVAS_HOST_PATH = "/__penguin__/canvas";

export const CANVAS_WS_PATH = "/__penguin__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.penguinCanvasA2UIAction.postMessage(...)
  // - Android: window.penguinCanvasA2UIAction.postMessage(...)
  const handlerNames = ["penguinCanvasA2UIAction"];
  ...
  globalThis.Penguin = globalThis.Penguin ?? {};
  globalThis.Penguin.postMessage = postToNode;
  globalThis.Penguin.sendUserAction = sendUserAction;
  globalThis.penguinPostMessage = postToNode;
  globalThis.penguinSendUserAction = sendUserAction;
