...
import type { GatewayBindMode, GatewayTailscaleMode, PenguinConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      ["Docs:", "https://docs.penguin.ai/gateway/tailscale", "https://docs.penguin.ai/web"].join(
        "\n",
      ),
      "Tailscale",
    );
