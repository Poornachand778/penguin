...
export function listBindings(cfg: PenguinConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: PenguinConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PenguinConfig) {
