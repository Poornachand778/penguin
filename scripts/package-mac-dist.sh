...
# Output:
# - dist/Penguin.app
# - dist/Penguin-<version>.zip
# - dist/Penguin-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Penguin-$VERSION.zip"
DMG="$ROOT_DIR/dist/Penguin-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Penguin-$VERSION.notary.zip"
