...
show_usage() {
    cat << EOF
clawlog - Penguin Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Penguin logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Penguin logs flow through the macOS unified log (subsystem: ai.penguin).
