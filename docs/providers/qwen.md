---
summary: "Use Qwen OAuth (free tier) in Penguin"
read_when:
  - You want to use Qwen with Penguin
...
```bash
penguin models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, Penguin will sync credentials
