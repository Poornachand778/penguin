...
You can point Penguin at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Penguin
...
- [Anthropic provider](/providers/anthropic) - Native Penguin integration with Claude setup-token or API keys
