---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Penguin"
read_when:
  - You want Xiaomi MiMo models in Penguin
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Penguin uses
...
```bash
penguin onboard --auth-choice xiaomi-api-key
# or non-interactive
penguin onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
