...
Deepgram is a speech-to-text API. In Penguin it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Penguin uploads the audio file to Deepgram and injects the transcript
