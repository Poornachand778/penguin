---
summary: "Model providers (LLMs) supported by Penguin"
read_when:
...
Penguin can use many LLM providers. Pick one, authenticate, then set the default
...
1. Authenticate with the provider (usually via `penguin onboard`).
