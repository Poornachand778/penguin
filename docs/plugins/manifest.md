...
read_when:
  - You are building a Penguin plugin
  - You need to ship a plugin config schema or debug plugin validation errors
---

# Plugin manifest (penguin.plugin.json)

Every plugin **must** ship a `penguin.plugin.json` file in the **plugin root**.
Penguin uses this manifest to validate configuration **without executing plugin
