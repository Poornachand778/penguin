...
This page ties together how Penguin handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Penguin keeps a
...
Penguin separates the **prompt body** from the **command body**:
...
Penguin can expose or hide model reasoning:
