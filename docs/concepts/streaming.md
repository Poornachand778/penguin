...
Penguin has two separate “streaming” layers:
...
When block streaming is enabled, Penguin can **merge consecutive block chunks**
...
When draft streaming is active, Penguin disables block streaming for that reply to avoid double-streaming.
