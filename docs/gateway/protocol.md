...
Penguin. All clients (CLI, web UI, macOS app, iOS/Android nodes, headless
...
- If `PENGUIN_GATEWAY_TOKEN` (or `--token`) is set, `connect.params.auth.token`
