...
Penguin treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.penguin/settings/voicewake.json`

Shape:

```json
{ "triggers": ["penguin", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
