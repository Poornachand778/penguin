...
- Install via CLI: `penguin plugins install @penguin/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `penguin plugins install ./extensions/zalo`
   - From npm (if published): `penguin plugins install @penguin/zalo`
...
- Approve via:
  - `penguin pairing list zalo`
  - `penguin pairing approve zalo <CODE>`
...
- Example: `penguin message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `penguin channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `penguin logs --follow`
