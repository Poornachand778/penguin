...
- Version alignment with core Penguin release numbers.
...
- First public release of the @penguin/voice-call plugin.
...
- CLI: `penguin voicecall` commands (call/start/continue/speak/end/status/tail/expose).
