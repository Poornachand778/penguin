...
export function listBlueBubblesAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: PenguinConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: PenguinConfig): ResolvedBlueBubblesAccount[] {
