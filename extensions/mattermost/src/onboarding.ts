import type { ChannelOnboardingAdapter, PenguinConfig, WizardPrompter } from "penguin/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.penguin.ai/channels/mattermost",
    ].join("\n"),
