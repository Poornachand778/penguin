...
export function listMattermostAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: PenguinConfig): string {
...
export function listEnabledMattermostAccounts(cfg: PenguinConfig): ResolvedMattermostAccount[] {
