...
export function listZalouserAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: PenguinConfig): string {
...
function mergeZalouserAccountConfig(cfg: PenguinConfig, accountId: string): ZalouserAccountConfig {
