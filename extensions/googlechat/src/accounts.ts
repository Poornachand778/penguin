...
export function listGoogleChatAccountIds(cfg: PenguinConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: PenguinConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: PenguinConfig): ResolvedGoogleChatAccount[] {
